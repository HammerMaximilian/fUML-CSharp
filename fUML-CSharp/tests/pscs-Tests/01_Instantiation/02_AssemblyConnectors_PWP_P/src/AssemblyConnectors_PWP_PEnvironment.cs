/*
 * AssemblyConnectors_PWP_PEnvironment.cs
 * 
 * Auto-generated file
 */
...
{
	public class AssemblyConnectors_PWP_PEnvironment : pscs.environment.Environment
	{
		private static AssemblyConnectors_PWP_PEnvironment? instance;

		public static AssemblyConnectors_PWP_PEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
				instance.inMemoryModel = AssemblyConnectors_PWP_PModel.Instance();
			}

			return instance;
		}

		public AssemblyConnectors_PWP_PEnvironment()
		{
			/*
