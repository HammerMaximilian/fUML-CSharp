/*
 * DefaultValue_StructuresEnvironment.cs
 * 
 * Auto-generated file
 */
...
{
	public class DefaultValue_StructuresEnvironment : pscs.environment.Environment
	{
		private static DefaultValue_StructuresEnvironment? instance;

		public static DefaultValue_StructuresEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
				instance.inMemoryModel = DefaultValue_StructuresModel.Instance();
			}

			return instance;
		}

		public DefaultValue_StructuresEnvironment()
		{
			/*
