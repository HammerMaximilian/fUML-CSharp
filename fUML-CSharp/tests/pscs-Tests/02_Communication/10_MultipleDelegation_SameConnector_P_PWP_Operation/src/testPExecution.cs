...
namespace MultipleDelegation_SameConnector_P_PWP_Operation
{
	public class testPExecution : OpaqueBehaviorExecution
	{
		...
		{
			types.Add(MultipleDelegation_SameConnector_P_PWP_OperationModel.Instance().MultipleDelegation_SameConnector_P_PWP_Operation_main_testP);
		...
		public override void DoBody(List<ParameterValue> inputParameters, List<ParameterValue> outputParameters)
		{
			if(index == 1)
	{
		Console.WriteLine("Asserting c.a[1].b.p == 4 || c.a[2].b.p == 4 || c.a[3].b.p == 4 || c.a[4].b.c == 4");
	}
