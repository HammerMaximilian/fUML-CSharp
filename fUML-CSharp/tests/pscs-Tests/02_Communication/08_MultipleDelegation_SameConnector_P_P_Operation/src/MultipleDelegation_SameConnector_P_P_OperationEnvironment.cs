/*
 * MultipleDelegation_SameConnector_P_P_OperationEnvironment.cs
 * 
 * Auto-generated file
 */
...
{
	public class MultipleDelegation_SameConnector_P_P_OperationEnvironment : pscs.environment.Environment
	{
		private static MultipleDelegation_SameConnector_P_P_OperationEnvironment? instance;

		public static MultipleDelegation_SameConnector_P_P_OperationEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
		...
		public MultipleDelegation_SameConnector_P_P_OperationEnvironment()
		{
			/*
