...
namespace MultipleDelegation_SameConnector_P_P_Operation
{
	public class testPExecution : OpaqueBehaviorExecution
	{
		...
		{
			types.Add(MultipleDelegation_SameConnector_P_P_OperationModel.Instance().MultipleDelegation_SameConnector_P_P_Operation_main_testP);
		...
		public override void DoBody(List<ParameterValue> inputParameters, List<ParameterValue> outputParameters)
		{
			if(index == 1)
	{
		Console.WriteLine("Asserting c.b[1] == 4 || c.b[2] == 4 || c.b[3] == 4 || c.b[4] == 4");
	}
