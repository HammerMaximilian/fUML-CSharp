/*
 * MultipleDelegation_SameConnector_P_P_SignalEnvironment.cs
 * 
 * Auto-generated file
 */
...
{
	public class MultipleDelegation_SameConnector_P_P_SignalEnvironment : pscs.environment.Environment
	{
		private static MultipleDelegation_SameConnector_P_P_SignalEnvironment? instance;

		public static MultipleDelegation_SameConnector_P_P_SignalEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
				instance.inMemoryModel = MultipleDelegation_SameConnector_P_P_SignalModel.Instance();
			}

			return instance;
		}

		public MultipleDelegation_SameConnector_P_P_SignalEnvironment()
		{
			/*
		...
		/*
 		 * End of user code
		 */
	} // MultipleDelegation_SameConnector_P_P_SignalEnvironment
}
