...
namespace SingleDelegation_P_PWP_Operation
{
	public class testPExecution : OpaqueBehaviorExecution
	{
		...
		{
			types.Add(SingleDelegation_P_PWP_OperationModel.Instance().SingleDelegation_P_PWP_Operation_main_testP);
