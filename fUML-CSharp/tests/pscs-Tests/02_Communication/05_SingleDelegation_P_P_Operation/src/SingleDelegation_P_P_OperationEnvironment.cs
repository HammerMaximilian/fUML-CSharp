/*
 * SingleDelegation_P_P_OperationEnvironment.cs
 * 
 * Auto-generated file
 */
...
{
	public class SingleDelegation_P_P_OperationEnvironment : pscs.environment.Environment
	{
		private static SingleDelegation_P_P_OperationEnvironment? instance;

		public static SingleDelegation_P_P_OperationEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
				instance.inMemoryModel = SingleDelegation_P_P_OperationModel.Instance();
			}

			return instance;
		}

		public SingleDelegation_P_P_OperationEnvironment()
		{
			/*
