/*
 * LossOfMessages_OperationEnvironment.cs
 * 
 * Auto-generated file
 */
...
{
	public class LossOfMessages_OperationEnvironment : pscs.environment.Environment
	{
		private static LossOfMessages_OperationEnvironment? instance;

		public static LossOfMessages_OperationEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
				instance.inMemoryModel = LossOfMessages_OperationModel.Instance();
			}

			return instance;
		}

		public LossOfMessages_OperationEnvironment()
		{
			/*
