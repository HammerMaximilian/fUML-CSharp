/*
 * MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment.cs
 * 
 * Auto-generated file
 */
...
{
	public class MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment : pscs.environment.Environment
	{
		private static MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment? instance;

		public static MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
				instance.inMemoryModel = MultipleDelegation_MultipleConnector_P_PWP_OperationModel.Instance();
			}

			return instance;
		}

		public MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment()
		{
			/*
		...
		/*
 		 * End of user code
		 */
	} // MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment
}
