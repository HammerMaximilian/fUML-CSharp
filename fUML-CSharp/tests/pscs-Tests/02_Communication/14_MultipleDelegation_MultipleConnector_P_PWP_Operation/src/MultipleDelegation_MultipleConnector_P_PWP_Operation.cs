...
{
	internal class MultipleDelegation_MultipleConnector_P_PWP_Operation
	{
		...
		static int Main(string[] args)
		{
			...
			{
				MultipleDelegation_MultipleConnector_P_PWP_OperationEnvironment.Instance().Execute(arg);
			}
