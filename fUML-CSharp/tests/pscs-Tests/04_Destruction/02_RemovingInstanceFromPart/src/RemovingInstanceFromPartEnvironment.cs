/*
 * RemovingInstanceFromPartEnvironment.cs
 * 
 * Auto-generated file
 */
...
{
	public class RemovingInstanceFromPartEnvironment : pscs.environment.Environment
	{
		private static RemovingInstanceFromPartEnvironment? instance;

		public static RemovingInstanceFromPartEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
		...
		public RemovingInstanceFromPartEnvironment()
		{
			/*
