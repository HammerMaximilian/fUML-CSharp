...
{
	public class SignalCommonEnvironment : pscs.environment.Environment
	{
		private static SignalCommonEnvironment? instance;

		public static SignalCommonEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
				instance.inMemoryModel = SignalCommonModel.Instance();
			}

			return instance;
		}

		public SignalCommonEnvironment()
		{
			/*
