...
{
	public class OperationCommonEnvironment : pscs.environment.Environment
	{
		private static OperationCommonEnvironment? instance;

		public static OperationCommonEnvironment Instance()
		{
			if(instance is null)
			{
				instance = new();
				instance.inMemoryModel = OperationCommonModel.Instance();
			}

			return instance;
		}

		public OperationCommonEnvironment()
		{
			/*
